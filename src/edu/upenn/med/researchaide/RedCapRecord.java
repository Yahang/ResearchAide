...
public class RedCapRecord {
	...
	public RedCapRecord(String record_id, String userName, String firstName, String lastName,
	...
	public String getRecords() {
		...
		String[] records = { "record_id", "username", "firstname", "lastname",
				"emailid", "password", "age", "gender", "race", "hcg" };
		
		if(recordAttributes.containsKey("record_id")) {
			data.append(recordAttributes.get(records[0])  + ",");
	...
	public String toString() {
		...
		if(recordAttributes.containsKey("record_id")) {
			data.append("record_id: " + recordAttributes.get(records[0]) + "\n");
		}
		
		for(int i=1;i<records.length;i++) {
			data.append(records[i] + ": " + recordAttributes.get(records[i]) + "\n");
		}
	...
	public static void main(String[] args) {
			String s = "test1";
			RedCapRecord rcb = new RedCapRecord(s,s, s, s, s, s, 10, s, s, s);
